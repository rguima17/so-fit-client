    ...
    >
      ...
      <div className='lg:w-1/2 md:w-1/2'>
        ...
        <div className='flex mx-2 mt-4'>
          <NavLink
            to={`/user-feed`}
            className='w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform rounded-md bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:bg-gray-600 animate-bounce text-center'
          >
            Go to your feed
          </NavLink>
        </div>
