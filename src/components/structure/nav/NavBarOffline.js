  ...
  return (
    <Popover>
          ...
          <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
            <div className="flex items-center justify-between w-full md:w-auto">
              ...
              <Link to="/">
                ...
                <img alt="" className="h-10 w-auto sm:h-10" src={Logo} />
              </Link>
            </div>
          </div>
        </nav>
      ...
      >
        ...
        >
          <div className="rounded-lg shadow-md bg-gray-800 bg-opacity-90 ring-1 ring-black ring-opacity-5 overflow-hidden">
